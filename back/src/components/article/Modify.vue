<template>
    <div>
        <h1 class="head"><i class="icon icon-quill"></i>修改文章<a href="javascript:history.back()"><span class="icon-undo2"></span>返回</a></h1>
        <ul class="form" v-if="info">
            ...
            <li class="item">
                <p class="left"><strong>*</strong> 文章标题：</p>
                <div class="right">
                    <input type="text" class="large" name="title" v-model="title" v-validate="'required|max:50'" maxlength="50" />
            ...
            <li class="item">
                <p class="left">文章描述：</p>
                <div class="right">
                    <input type="text" class="large" name="desc" v-model="desc" v-validate="'max:200'" maxlength="200" />
                    <b class="errors" v-show="errors.has('desc')">{{errors.first('desc')}}</b>
                </div>
            </li>
            <li class="item">
                <p class="left">缩略图：</p>
                <v-upload class="thumb" :url="thumb" size="300kb" @uploadFile="uploadFile" @cancelUpload="cancelUpload"></v-upload>
            </li>
            <li class="item">
                <p class="left"><strong>*</strong> 内容：</p>
                <div class="editor">
            ...
            <li class="item">
                ...
                <div class="right" ref="original">
                    <label><input name="original" type="radio" value="1" v-model="original" /> 是</label>
                    <label><input name="original" type="radio" value="0" v-model="original" /> 否</label>
                </div>
            </li>
            <li class="item">
                <p class="left"></p>
...
import {formatHtml, toBase64, isModified, modifyList} from '@/resource/js/common.js'
